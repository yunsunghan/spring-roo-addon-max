...
@Service
public class MaxServiceCommands implements CommandMarker { // All command types must implement the CommandMarker interface
	
	/**
	 * Get a reference to the MaxserviceOperations from the underlying OSGi container
	 */
	@Reference private MaxServiceOperations operations;
	...
	/**
	 * This method registeres a command with the Roo shell. It also offers a mandatory command attribute.
	 * 
	 * @param type 
	 */
	@CliCommand(value = "max service", help = "Max Service create interface,service,DTO...")
	public void service(@CliOption(key = "class", mandatory = true, help = "create service name") JavaType serviceClazz,
